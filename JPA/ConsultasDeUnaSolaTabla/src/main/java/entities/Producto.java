...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Producto.findAll", query =
            "SELECT p FROM Producto p"),
    @NamedQuery(name =
            "Producto.findByPkproducto", query =
            "SELECT p FROM Producto p WHERE p.pkproducto = :pkproducto"),
    @NamedQuery(name =
            "Producto.findByNombre", query =
            "SELECT p FROM Producto p WHERE p.nombre = :nombre"),
    @NamedQuery(name =
            "Producto.findByPvp", query =
            "SELECT p FROM Producto p WHERE p.pvp = :pvp"),
    @NamedQuery(name =
            "Producto.findByStock", query =
